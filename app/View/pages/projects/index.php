...
<head>
    ...
    <title>TaskGroup - Projects</title>
            ...
            <div class="col-lg-10 col-md-9 bg-tg-primary-10">
                <main class="main-content py-4 bg-tg-primary-10">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="h2 fw-bold text-white">Projects</h1>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card border-0 shadow-sm bg-tg-grey">
                                    <div class="card-body">
                                        <h2 class="h4 card-title text-light">Project Name Example</h2>
