...
<head>
    ...
    <title>TaskGroup - Project X</title>
            ...
            <div class="d-flex align-items-center justify-content-between py-2">
                ...
                <nav class="d-none d-md-flex align-items-center">
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a href="<?= BASE_URL ?>/app/View/pages/dashboard.php" class="nav-link">
                                <i class="bi bi-speedometer2 me-1"></i>Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= BASE_URL ?>/app/View/pages/projects/project_list.php" class="nav-link active">
            ...
            <div class="col-lg-2 col-md-3 d-md-block collapse bg-tg-dark" id="sidebarCollapse">
                <aside class="sidebar bg-dark vh-100 sticky-top pt-3 bg-tg-dark" style="top: 56px;">
                    <nav class="nav flex-column">
                        <a href="<?= BASE_URL ?>/app/View/pages/dashboard.php" class="nav-link py-3">
                            <i class="bi bi-speedometer2 me-2"></i>Dashboard
                        </a>
                        <a href="<?= BASE_URL ?>/app/View/pages/projects/project_list.php" class="nav-link active py-3">
            ...
            <div class="col-lg-10 col-md-9 bg-tg-primary-10">
                <main class="main-content py-4 bg-tg-primary-10">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="h2 fw-bold text-white">Project X</h1>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card border-0 shadow-sm bg-tg-grey">
                                    <div class="card-body">
                                        <h2 class="h4 card-title text-light">Project X Data</h2>
                                        <p class="card-text text-white">This is a project description example.</p>
                                        
                                        <div class="row mt-4">
                                            <div class="col-md-3 mb-3">
                                                <div class="card bg-tg-primary text-white">
                                                    <div class="card-body text-center">
                                                        <h3 class="h6">Completed Tasks</h3>
                                                        <div class="h2 fw-bold">777</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <div class="card bg-tg-secondary text-white">
                                                    <div class="card-body text-center">
                                                        <h3 class="h6">To-do's</h3>
                                                        <div class="h2 fw-bold">3333</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
